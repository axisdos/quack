<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-01-29 12:42:07
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <div class="postbit">
                ...
                <?php } else { ?>
                    <img onError="this.onerror=null;this.src='images/noav.png';" src="<?php echo $_smarty_tpl->tpl_vars['firstpost']->value['avatar'];?>
" class="avatar"  />
                <?php }?>
                ...
                <span class="pull-right">
                    <?php echo timeAgo($_smarty_tpl->tpl_vars['firstpost']->value['postdate']);?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <br />
                    <?php echo $_smarty_tpl->tpl_vars['firstpost']->value['thread_content'];?>
...
" class="avatar" />
                        ...
                        <span class="pull-right">
                            <?php echo timeAgo($_smarty_tpl->tpl_vars['post']->value['postdate']);?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br />
                            <?php echo $_smarty_tpl->tpl_vars['post']->value['reply_content'];?>
